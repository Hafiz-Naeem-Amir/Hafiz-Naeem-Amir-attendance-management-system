...
<body data-base-url="https://www.kingpabel.com/attendance-management-system">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end nav-bg-color">
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li wire:initial-data="{&quot;id&quot;:&quot;BJQC6HnAxWcaJIl7aOVx&quot;,&quot;name&quot;:&quot;header-notification&quot;,&quot;redirectTo&quot;:false,&quot;locale&quot;:&quot;en&quot;,&quot;events&quot;:[],&quot;eventQueue&quot;:[],&quot;dispatchQueue&quot;:[],&quot;data&quot;:{&quot;readyToLoad&quot;:false},&quot;children&quot;:[],&quot;checksum&quot;:&quot;99f749d2add75b3598b400ed36265d12dccd155ddabc0604c782188a1bb8f2eb&quot;}" wire:id="BJQC6HnAxWcaJIl7aOVx" class="nav-item dropdown" id="nav-c-noti" wire:init="$set('readyToLoad', 'true')">
              ...
              <div class="card">
                <div class="card-body sticky-breadcrumb">
                  <div class="bcca-breadcrumb float-left">
                    <div class="bcca-breadcrumb-item">Designation</div>
...
<div class="row">
    <div class="col-lg-5 grid-margin">
        <div wire:initial-data="{&quot;id&quot;:&quot;l4Damr5rIgCYgOgGDYxx&quot;,&quot;name&quot;:&quot;designation-create&quot;,&quot;redirectTo&quot;:false,&quot;locale&quot;:&quot;en&quot;,&quot;events&quot;:[],&quot;eventQueue&quot;:[],&quot;dispatchQueue&quot;:[],&quot;data&quot;:{&quot;bulkApply&quot;:null,&quot;bulkSpecific&quot;:[],&quot;name&quot;:null},&quot;children&quot;:[],&quot;checksum&quot;:&quot;22b64ddfd57d5b08149223e6f10707f79109aca2ec2ebf90a079abec54e06cf3&quot;}" wire:id="l4Damr5rIgCYgOgGDYxx" class="card">
    <div class="card-body">
        <h4 class="card-title">Create New Designation</h4>
        <p class="card-description"> </p>
        <form wire:submit.prevent="save" class="forms-sample" x-data="{users:[]}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input wire:model="name" class="form-control " id="nameInput"
                        placeholder="Name..." type="text"
                        @focus.once="axios.get('https://www.kingpabel.com/attendance-management-system/user/json').then(({data})=>users=data.data)"
            ...
            <div class="form-group row">
                <div class="offset-sm-3">
                    <button class="btn btn-success ml-2 btn-fw" type="submit">
                        <i wire:loading wire:target="save" class="spinner-border spinner-border-sm" role="status"
                            aria-hidden="true"></i>
    ...
    <div class="col-lg-7 grid-margin">
        <div wire:initial-data="{&quot;id&quot;:&quot;sQCckYmNIPXfLKMYo1RI&quot;,&quot;name&quot;:&quot;designation-list&quot;,&quot;redirectTo&quot;:false,&quot;locale&quot;:&quot;en&quot;,&quot;events&quot;:[&quot;toastrNoti&quot;,&quot;deleteDesignation&quot;],&quot;eventQueue&quot;:[],&quot;dispatchQueue&quot;:[],&quot;data&quot;:{&quot;readyToLoad&quot;:false,&quot;page&quot;:1},&quot;children&quot;:[],&quot;checksum&quot;:&quot;c5c74f6fca9b25f74045dc58fd41eaf4821a9f52d4f4fa658b08c958219165c4&quot;}" wire:id="sQCckYmNIPXfLKMYo1RI" class="card" wire:init="$set('readyToLoad', 'true')">
    <div class="card-body">
    ...
    <table class="table table-bordered with-drop-button">
        ...
        <tbody>
                        <tr>
                <td>
                    <span class="loading-transition">416</span>
                </td>
                <td>
                ...
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                        ...
                        <tr>
                <td>
                    <span class="loading-transition">698</span>
                </td>
                <td>
                ...
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                        ...
                        <tr>
                <td>
                    <span class="loading-transition">855</span>
                </td>
                <td>
                ...
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                        ...
                        <tr>
                <td>
                    <span class="loading-transition">951</span>
                </td>
                <td>
                ...
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                        ...
                        <tr>
                <td>
                    <span class="loading-transition">789</span>
                </td>
                <td>
                ...
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                        ...
                        <tr>
                <td>
                    <span class="loading-transition">440</span>
                </td>
                <td>
                    <span class="loading-transition">_____________</span>
                </td>
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                        ...
                        <tr>
                <td>
                    <span class="loading-transition">927</span>
                </td>
                <td>
                    <span class="loading-transition">___________</span>
                </td>
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                        ...
                        <tr>
                <td>
                    <span class="loading-transition">877</span>
                </td>
                <td>
                ...
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                        ...
                        <tr>
                <td>
                    <span class="loading-transition">799</span>
                </td>
                <td>
                    <span class="loading-transition">_________________</span>
                </td>
                <td>
                    <span class="btn btn-sm loading-transition">_____</span>
                </td>
...
<script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>  <script>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/axios/0.19.2/axios.min.js"></script></body>
