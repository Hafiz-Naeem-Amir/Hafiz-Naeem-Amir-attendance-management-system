! function(global, factory) {
    ...
    } : MessageChannel && !engineIsIos ? (channel = new MessageChannel, port = channel.port2, channel.port1.onmessage = listener, defer = functionBindContext(port.postMessage, port, 1)) : !global_1.addEventListener || "function" != typeof postMessage || global_1.importScripts || fails(post) ? defer = ONREADYSTATECHANGE in documentCreateElement("script") ? function(id) {
    ...
    function fetch$1(input, init) {
        return new Promise((function(resolve, reject) {
            ...
            }, xhr.open(request.method, request.url, !0), "include" === request.credentials ? xhr.withCredentials = !0 : "omit" === request.credentials && (xhr.withCredentials = !1), "responseType" in xhr && support.blob && (xhr.responseType = "blob"), request.headers.forEach((function(value, name) {
    ...
    fetch$1.polyfill = !0, self.fetch || (self.fetch = fetch$1, self.Headers = Headers, self.Request = Request, self.Response = Response), null == Element.prototype.getAttributeNames && (Element.prototype.getAttributeNames = function() {
    ...
    var _default = function() {
        ...
        _default$1 = function(_Action) {
            function _default(event, params, el) {
                var _this;
                return _classCallCheck(this, _default), (_this = _possibleConstructorReturn(this, _getPrototypeOf(_default).call(this, el))).type = "fireEvent", _this.payload = {
                    event: event,
                    params: params
                }, _this
            }
            return _inherits(_default, _Action), _createClass(_default, [{
                key: "toId",
                value: function() {
    ...
    var DOMElement = function() {
        ...
        _default$5 = function(_Message) {
            function _default(component, action) {
                return _classCallCheck(this, _default), _possibleConstructorReturn(this, _getPrototypeOf(_default).call(this, component, [action]))
            }
            return _inherits(_default, _Message), _createClass(_default, [{
                key: "payload",
                value: function() {
    ...
    var morphdom = morphdomFactory(morphAttrs),
        _default$6 = function(_Action) {
            function _default(name, value, el) {
                var _this;
                return _classCallCheck(this, _default), (_this = _possibleConstructorReturn(this, _getPrototypeOf(_default).call(this, el))).type = "syncInput", _this.payload = {
                    name: name,
                    value: value
                }, _this
            }
            return _inherits(_default, _Action), _default
        }(_default),
        _default$7 = function(_Action) {
            function _default(method, params, el) {
                var _this;
                return _classCallCheck(this, _default), (_this = _possibleConstructorReturn(this, _getPrototypeOf(_default).call(this, el))).type = "callMethod", _this.payload = {
                    method: method,
                    params: params
                }, _this
            }
    ...
    function UpdateQueryString() {
        store$2.registerHook("responseReceived", (function(component, response) {
            if (void 0 !== response.updatesQueryString) {
                ...
                var queryData = _objectSpread2({}, queryString.parse(window.location.search), {}, dataDestinedForQueryString);
                ...
                history.replaceState({
                    turbolinks: {}
                }, "", [window.location.pathname, stringifiedQueryString].filter(Boolean).join("?"))
            }
        }))
    }
