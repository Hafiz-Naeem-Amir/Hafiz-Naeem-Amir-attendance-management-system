...
<body data-base-url="https://www.kingpabel.com/attendance-management-system">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end nav-bg-color">
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li wire:initial-data="{&quot;id&quot;:&quot;k0Dd9wj5db5R2Qq44jkj&quot;,&quot;name&quot;:&quot;header-notification&quot;,&quot;redirectTo&quot;:false,&quot;locale&quot;:&quot;en&quot;,&quot;events&quot;:[],&quot;eventQueue&quot;:[],&quot;dispatchQueue&quot;:[],&quot;data&quot;:{&quot;readyToLoad&quot;:false},&quot;children&quot;:[],&quot;checksum&quot;:&quot;76d6eb2ec8b7c6a16cc768a593ac0177b9bdd9352dd71330ea64ad733b138ca0&quot;}" wire:id="k0Dd9wj5db5R2Qq44jkj" class="nav-item dropdown" id="nav-c-noti" wire:init="$set('readyToLoad', 'true')">
              ...
              <div class="card">
                <div class="card-body sticky-breadcrumb">
                  <div class="bcca-breadcrumb float-left">
                    <div class="bcca-breadcrumb-item">Summary</div>
<div class="bcca-breadcrumb-item">Report</div>
    ...
    <div class="col-lg-12 grid-margin">
        <div class="card">
            <div wire:initial-data="{&quot;id&quot;:&quot;KFBuNvjwmdA5i3zR1mBu&quot;,&quot;name&quot;:&quot;dashboard-summary-report&quot;,&quot;redirectTo&quot;:false,&quot;locale&quot;:&quot;en&quot;,&quot;events&quot;:[],&quot;eventQueue&quot;:[],&quot;dispatchQueue&quot;:[],&quot;data&quot;:{&quot;dateRange&quot;:&quot;December 14, 2025 to January 13, 2026&quot;,&quot;readyToLoad&quot;:false},&quot;children&quot;:[],&quot;checksum&quot;:&quot;942ca8174dce40729fdf65a0e8f1b1fb26af01d5d770f35d490a9f020bbd3fae&quot;}" wire:id="KFBuNvjwmdA5i3zR1mBu" class="card-body" wire:init="$set('readyToLoad', 'true')">
    <h4 class="card-title">
        <input placeholder="Search by Date Range..." class="w-50 form-control float-right datepicker"
            value="December 14, 2025 to January 13, 2026" style="max-width: 230px">
    </h4>

    <div class="table-responsive" wire:loading>
    <table class="table table-striped">
        ...
        <tbody class="loading-transition-background">
                        <tr>
                <td> <span class="loading-transition">195</span> </td>
                <td> <span class="loading-transition">__________</span> </td>
                <td> <span class="loading-transition">__________</span> </td>
            </tr>
                        <tr>
                <td> <span class="loading-transition">452</span> </td>
                <td> <span class="loading-transition">______________</span> </td>
                <td> <span class="loading-transition">__________</span> </td>
            </tr>
                        <tr>
                <td> <span class="loading-transition">62</span> </td>
                <td> <span class="loading-transition">______________</span> </td>
                <td> <span class="loading-transition">__________</span> </td>
            </tr>
                        <tr>
                <td> <span class="loading-transition">652</span> </td>
                <td> <span class="loading-transition">___________</span> </td>
                <td> <span class="loading-transition">__________</span> </td>
            </tr>
                        <tr>
                <td> <span class="loading-transition">612</span> </td>
                <td> <span class="loading-transition">_____________</span> </td>
                <td> <span class="loading-transition">__________</span> </td>
            </tr>
                    </tbody>
    </table>
        ...
        onClose: function(selectedDates, dateStr, instance){
            if('December 14, 2025 to January 13, 2026' != dateStr){
                if (dateStr.includes('to')) {
                    window.livewire.find('KFBuNvjwmdA5i3zR1mBu').set('dateRange', dateStr)
                } else{
                    instance.setDate('December 14, 2025 to January 13, 2026'.split(' to '));
                    window.livewire.find('KFBuNvjwmdA5i3zR1mBu').set('dateRange', 'December 14, 2025 to January 13, 2026');
                }
            }
        }
    })
